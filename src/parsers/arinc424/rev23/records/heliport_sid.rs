...
impl HeliportSIDRecords {
    ...
    pub fn parse(input: &[u8]) -> Result<ARINCRecord<'_>, RecordParseError> {
        if is_primary_record(input, Self::CONTINUATION_COLUMN) {
            Ok(ARINCRecord::HeliportSIDPrimary(
                HeliportSIDPrimaryRecord::parse(input)?,
            ))
        } else {
            match ContinuationRecordApplicationType::from_bytes(
                ...
                Some(ContinuationRecordApplicationType::StandardContinuation) => {
                    Ok(ARINCRecord::HeliportSIDPrimaryExtensionContinuation(
                        HeliportSIDPrimaryExtensionContinuationRecord::parse(input)?,
                    ))
                }
                Some(ContinuationRecordApplicationType::FlightPlanningContinuation) => {
                    Ok(ARINCRecord::HeliportSIDFlightPlanningContinuation(
                        HeliportSIDFlightPlanningContinuationRecord::parse(input)?,
                    ))
                }
                Some(ContinuationRecordApplicationType::AirportSIDSTARApproachProcedureNameContinuation) => {
                    Ok(ARINCRecord::HeliportSIDProcedureNameContinuation(
                        HeliportSIDProcedureNameContinuationRecord::parse(input)?,
                    ))
                }
...
#[derive(Debug)]
pub struct HeliportSIDPrimaryRecord<'a> {
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for HeliportSIDPrimaryRecord<'a> {
    fn record_name() -> &'static str {
        "HeliportSIDPrimaryRecord"
    }
...
#[derive(Debug)]
pub struct HeliportSIDPrimaryExtensionContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub heliport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for HeliportSIDPrimaryExtensionContinuationRecord<'a> {
    fn record_name() -> &'static str {
        "HeliportSIDPrimaryExtensionContinuationRecord"
    }
...
#[derive(Debug)]
pub struct HeliportSIDFlightPlanningContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub heliport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for HeliportSIDFlightPlanningContinuationRecord<'a> {
    fn record_name() -> &'static str {
        "HeliportSIDFlightPlanningContinuationRecord"
    }
...
#[derive(Debug)]
pub struct HeliportSIDProcedureNameContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub heliport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for HeliportSIDProcedureNameContinuationRecord<'a> {
    fn record_name() -> &'static str {
        "HeliportSIDProcedureNameContinuationRecord"
    }
