        ...
        if is_primary_record(input, Self::CONTINUATION_COLUMN) {
            ...
            match ContinuationRecordApplicationType::from_bytes(
                ...
                Some(ContinuationRecordApplicationType::PrimaryRecordExtension) => {
                    Ok(ARINCRecord::AirportCommsPrimaryExtensionContinuation(
                        AirportCommsPrimaryExtensionContinuationRecord::parse(input)?,
                    ))
                }
...
#[derive(Debug)]
pub struct AirportCommsPrimaryExtensionContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
// 4.1.14.3 Airport Communications Sector Narrative Continuation Record
#[derive(Debug)]
...
// 4.1.14.5 Airport Communications Additional Sectorization Continuation Record
#[derive(Debug)]
pub struct AirportCommsAdditionalSectorizationContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
