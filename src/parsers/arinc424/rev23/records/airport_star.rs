...
pub(super) struct AirportSTARRecords;
impl AirportSTARRecords {
    ...
    pub fn parse(input: &[u8]) -> Result<ARINCRecord<'_>, RecordParseError> {
        if is_primary_record(input, Self::CONTINUATION_COLUMN) {
            Ok(ARINCRecord::AirportSTARPrimary(
                AirportSTARPrimaryRecord::parse(input)?,
            ))
        } else {
            match ContinuationRecordApplicationType::from_bytes(
                ...
                Some(ContinuationRecordApplicationType::StandardContinuation) => {
                    Ok(ARINCRecord::AirportSTARPrimaryExtensionContinuation(
                        AirportSTARPrimaryExtensionContinuationRecord::parse(input)?,
                    ))
                }
                Some(ContinuationRecordApplicationType::FlightPlanningContinuation) => {
                    Ok(ARINCRecord::AirportSTARFlightPlanningContinuation(
                        AirportSTARFlightPlanningContinuationRecord::parse(input)?,
                    ))
                }
                Some(ContinuationRecordApplicationType::AirportSIDSTARApproachProcedureNameContinuation) => {
                    Ok(ARINCRecord::AirportSTARProcedureNameContinuation(
                        AirportSTARProcedureNameContinuationRecord::parse(input)?,
                    ))
                }
...
#[derive(Debug)]
pub struct AirportSTARPrimaryRecord<'a> {
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for AirportSTARPrimaryRecord<'a> {
    fn record_name() -> &'static str {
        "AirportSTARPrimaryRecord"
    }
...
#[derive(Debug)]
pub struct AirportSTARPrimaryExtensionContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for AirportSTARPrimaryExtensionContinuationRecord<'a> {
    fn record_name() -> &'static str {
        "AirportSTARPrimaryExtensionContinuationRecord"
    }
...
#[derive(Debug)]
pub struct AirportSTARFlightPlanningContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for AirportSTARFlightPlanningContinuationRecord<'a> {
    fn record_name() -> &'static str {
        "AirportSTARFlightPlanningContinuationRecord"
    }
...
#[derive(Debug)]
pub struct AirportSTARProcedureNameContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for AirportSTARProcedureNameContinuationRecord<'a> {
    fn record_name() -> &'static str {
        "AirportSTARProcedureNameContinuationRecord"
    }
