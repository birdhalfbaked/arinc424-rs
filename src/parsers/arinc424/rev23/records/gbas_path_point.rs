...
impl AirportGBASRecords {
    ...
    pub fn parse(input: &[u8]) -> Result<ARINCRecord<'_>, RecordParseError> {
        if is_primary_record(input, Self::CONTINUATION_COLUMN) {
            ...
            {
                Ok(ARINCRecord::AirportRunwayGBASPathPointPrimary(
                    AirportRunwayGBASPathPointPrimaryRecord::parse(input)?,
                ))
            } else {
                Ok(
                    ARINCRecord::AirportFinalApproachCourseAsRunwayGBASPathPointPrimary(
                        AirportFinalApproachCourseAsRunwayGBASPathPointPrimaryRecord::parse(input)?,
                    ),
                )
            }
        } else {
            if input[Self::DISCRIMINATOR_COLUMN - 1..Self::DISCRIMINATOR_COLUMN + 1] == [b'R', b'W']
            {
                match ContinuationRecordApplicationType::from_bytes(
                    ...
                    Some(ContinuationRecordApplicationType::StandardContinuation) => {
                        Ok(ARINCRecord::AirportRunwayGBASPathPointContinuation(
                ...
                match ContinuationRecordApplicationType::from_bytes(
                    ...
                    Some(ContinuationRecordApplicationType::StandardContinuation) => {
                        Ok(ARINCRecord::AirportFinalApproachCourseAsRunwayGBASPathPointContinuation(
                            AirportFinalApproachCourseAsRunwayGBASPathPointContinuationRecord::parse(input)?,
                        ))
                    }
                    _ => Err(RecordParseError {
                        message: "Invalid continuation record application type".to_string(),
...
/// 4.1.35.1(A) Airport Runway GBAS Path Point Primary Record
#[derive(Debug)]
pub struct AirportRunwayGBASPathPointPrimaryRecord<'a> {
    ...
    pub operation_type: RecordField<'a, GBASOperationType>,
...
/// 4.1.35.1(B) Airport Final Approach Course as Runway GBAS Path Point Primary Record
#[derive(Debug)]
pub struct AirportFinalApproachCourseAsRunwayGBASPathPointPrimaryRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[derive(Debug)]
pub struct AirportRunwayGBASPathPointContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
/// 4.1.35.2(B) Airport Final Approach Course as Runway GBAS Path Point Continuation Record
#[derive(Debug)]
pub struct AirportFinalApproachCourseAsRunwayGBASPathPointContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
