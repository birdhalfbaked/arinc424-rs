...
pub(super) struct AirportMSARecords;
impl AirportMSARecords {
    ...
    pub fn parse(input: &[u8]) -> Result<ARINCRecord<'_>, RecordParseError> {
        if is_primary_record(input, Self::CONTINUATION_COLUMN) {
            Ok(ARINCRecord::AirportMSAPrimary(
                AirportMSAPrimaryRecord::parse(input)?,
            ))
        } else {
            match ContinuationRecordApplicationType::from_bytes(
                ...
                Some(ContinuationRecordApplicationType::PrimaryRecordExtension) => {
                    Ok(ARINCRecord::AirportMSAPrimaryExtensionContinuation(
                        AirportMSAPrimaryExtensionContinuationRecord::parse(input)?,
                    ))
                }
                Some(ContinuationRecordApplicationType::StandardContinuation) => {
                    Ok(ARINCRecord::AirportMSAContinuation(
                        AirportMSAContinuationRecord::parse(input)?,
                    ))
                }
...
#[derive(Debug)]
pub struct AirportMSAPrimaryRecord<'a> {
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for AirportMSAPrimaryRecord<'a> {
    fn record_name() -> &'static str {
        "AirportMSAPrimaryRecord"
    }
...
/// 4.1.20.2 Airport MSA Primary Extension Continuation Record
#[derive(Debug)]
pub struct AirportMSAPrimaryExtensionContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for AirportMSAPrimaryExtensionContinuationRecord<'a> {
    fn record_name() -> &'static str {
        "AirportMSAPrimaryExtensionContinuationRecord"
    }
...
/// 4.1.20.3 Airport MSA Continuation Record
#[derive(Debug)]
pub struct AirportMSAContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub airport_identifier: RecordField<'a, AirportHeliportIdentifier>,
...
#[rustfmt::skip]
impl<'a> Arinc424RecordSpec<'a> for AirportMSAContinuationRecord<'a> {
    fn record_name() -> &'static str {
        "AirportMSAContinuationRecord"
    }
