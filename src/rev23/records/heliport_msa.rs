        ...
        if is_primary_record(input, Self::CONTINUATION_COLUMN) {
            ...
            match ContinuationRecordApplicationType::from_bytes(
                ...
                Some(ContinuationRecordApplicationType::PrimaryRecordExtension) => {
                    Ok(ARINCRecord::HeliportMSAPrimaryExtensionContinuation(
                        HeliportMSAPrimaryExtensionContinuationRecord::parse(input)?,
                    ))
                }
...
/// 4.2.4.1 Heliport MSA Primary Record
#[derive(Debug)]
...
/// 4.2.4.2 Heliport MSA Primary Extension Continuation Record
#[derive(Debug)]
pub struct HeliportMSAPrimaryExtensionContinuationRecord<'a> {
    pub record_type: RecordField<'a, RecordType>,
    pub customer_area_code: RecordField<'a, CustomerAreaCode>,
    pub section: RecordField<'a, Section>,
    pub heliport_identifier: RecordField<'a, AirportHeliportIdentifier>,
